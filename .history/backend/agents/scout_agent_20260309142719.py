...
class ScoutAgent:
    ...
    def download_pdf_process(self, doi):
        """Attempt to retrieve a PDF using Unpaywall and cache it locally.

        This wraps the new pdf_loader helper to keep caching logic in one place.
        """
        # check cache first
        ...
        # call Unpaywall to get a PDF link
        ...
        try:
            ...
            if r.status_code == 200:
                ...
                if pdf_url:
                    # delegate to shared downloader
                    return fetch_pdf_by_doi(doi, pdf_url)
        except Exception:
            pass
        return None
