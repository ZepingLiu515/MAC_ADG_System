...
| `backend/agents/scout_agent.py` | ✅ | 架构调整为仅元数据获取 | ✅ 已更新为浏览器截图架构 |
| `backend/agents/vision_agent.py` | ✅ | 架构调整为浏览器截图 | ✅ 已实现Playwright自动化 |
...
| Vision Agent 架构调整 | 🔴 高 | ✅ 已完成 | 实现浏览器截图替代PDF下载 |
