...
- 论文级命中（是否识别到名单川大教师）：Accuracy=60.00%（TP=3 FP=0 TN=0 FN=2）
- 作者级名单匹配（真值阳性论文）：F1=36.36%（Precision=100.00% Recall=22.22%；TP=4 FP=0 FN=14）
- 通讯作者标记（真值阳性论文）：F1=75.00%（Precision=100.00% Recall=60.00%；TP=3 FN=2）
- 共一标记（真值阳性论文）：Recall=0.00%（TP=0 FN=2）
