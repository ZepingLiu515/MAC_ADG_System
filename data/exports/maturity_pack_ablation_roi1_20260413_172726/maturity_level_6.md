...
本次统计摘要（由系统自动汇总）：
- 论文终态 Top1：NEEDS_REVIEW（5 篇）
- 平均每篇论文作者数：12.0；平均匹配到教师库作者数：3.4
...
- 作者级匹配：F1=91.43%（Precision=94.12% Recall=88.89%）
- 通讯作者标记：Recall=100.00%（TP=5 FN=0）
- 共一标记：Recall=100.00%（TP=2 FN=0）
